...
namespace VNTourLandProject.Pages.Profile
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(UserUtility userUtility, IChatService chatService, IFileUploadService fileUploadService, IIUserService iUserService )
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            if (isAuth)
            {
                var userResponse = await _userService.GetUserById();
                if (userResponse.IsSuccess && userResponse.Result != null)
                {
                    UserDTO = userResponse.Result as UserDTO;
                }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (response.Success)
            {
                ...
                return RedirectToPage(); // reload để cập nhật
            }
