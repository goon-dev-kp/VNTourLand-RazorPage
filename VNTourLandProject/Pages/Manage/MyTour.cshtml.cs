...
{
    public class MyTourModel : PageModel
    {
        ...
        // ✅ Dữ liệu chính
        public List<TourDTO> MyTours { get; set; } = new();
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var response = await _tourService.GetTourByUserId();
        ...
        // ✅ GET tin nhắn giữa bạn và 1 khách
