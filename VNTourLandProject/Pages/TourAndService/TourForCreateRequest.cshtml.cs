...
{
    public class TourForCreateRequestModel : PageModel
    {
        ...
        public TourForCreateRequestModel(UserUtility userUtility, ITourService tourService, IIncludeService includeService, INotIncludeService notIncludeService, IItineraryService itineraryService, IBookingService bookingService, IReviewerService reviewerService, IChatService chatService, IFileUploadService fileUploadService, IRequestOfCustomerService requestService, IOptions<MapboxOptions> options)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                {
                    TempData["Message"] = "Failed to load tour information.";
                    return Page();
                }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var reponse = await _requestService.CreateRequestOfCustomerAsync(RequestOfCustomer, userId);
            ...
            return RedirectToPage("/TourAndService/Index");
