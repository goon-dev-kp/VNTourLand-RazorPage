...
{
    public class DashboardOfAdminModel : PageModel
    {
        private readonly UserUtility _userUtility;
        private readonly IChatService _chatService;
        private readonly IFileUploadService _fileUploadService;
        public DashboardOfAdminModel(UserUtility userUtility, IChatService chatService, IFileUploadService fileUploadService)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                TempData["Message"] = "You must be logged in first.";
